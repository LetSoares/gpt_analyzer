...
st.markdown(f"""
    ...
    <div style="text-align: center; padding: 20px 0 5px 0;">
        ...
        <div style="display: flex; justify-content: center; gap: 16px; margin-top: 8px;">
            <a href="https://instagram.com/SEU_PERFIL" target="_blank" style="color: inherit; text-decoration: none;">
            ...
            <a href="https://linkedin.com/in/SEU_PERFIL" target="_blank" style="color: inherit; text-decoration: none;">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="width:22px; height:22px; fill:#060638;">
